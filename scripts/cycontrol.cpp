...
static int __pyx_pw_14cython_control_9c_control_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    ...
    __pyx_v_m = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_m == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_g = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_g == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
  }
 ...
 */
  try {
    __pyx_t_1 = new controller();
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 12, __pyx_L1_error)
  }
  __pyx_v_self->c_control = __pyx_t_1;
...
static PyObject *__pyx_pf_14cython_control_9c_control_2position_control(struct __pyx_obj_14cython_control_c_control *__pyx_v_self, PyArrayObject *__pyx_v_a) {
  ...
  __pyx_pybuffernd_a.rcbuffer = &__pyx_pybuffer_a;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_a.rcbuffer->pybuffer, (PyObject*)__pyx_v_a, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
...
#endif
{
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_14cython_control_c_control) < 0) __PYX_ERR(0, 9, __pyx_L1_error)
  __pyx_type_14cython_control_c_control.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "c_control", (PyObject *)&__pyx_type_14cython_control_c_control) < 0) __PYX_ERR(0, 9, __pyx_L1_error)
