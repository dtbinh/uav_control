...
static int __pyx_pf_14cython_control_9c_control___cinit__(struct __pyx_obj_14cython_control_c_control *__pyx_v_self, CYTHON_UNUSED double __pyx_v_m, CYTHON_UNUSED double __pyx_v_g); /* proto */
static PyObject *__pyx_pf_14cython_control_9c_control_2position_control(struct __pyx_obj_14cython_control_c_control *__pyx_v_self, PyArrayObject *__pyx_v_a); /* proto */
...
static int __pyx_pw_14cython_control_9c_control_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_m,&__pyx_n_s_g,0};
    ...
    __pyx_v_m = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_m == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_g = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_g == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_14cython_control_9c_control___cinit__(((struct __pyx_obj_14cython_control_c_control *)__pyx_v_self), __pyx_v_m, __pyx_v_g);
...
static int __pyx_pf_14cython_control_9c_control___cinit__(struct __pyx_obj_14cython_control_c_control *__pyx_v_self, CYTHON_UNUSED double __pyx_v_m, CYTHON_UNUSED double __pyx_v_g) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
 ...
 */
  __pyx_v_self->c_control = new controller();
...
/* Python wrapper */
static PyObject *__pyx_pw_14cython_control_9c_control_3position_control(PyObject *__pyx_v_self, PyObject *__pyx_v_a); /*proto*/
static PyObject *__pyx_pw_14cython_control_9c_control_3position_control(PyObject *__pyx_v_self, PyObject *__pyx_v_a) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("position_control (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_a), __pyx_ptype_5numpy_ndarray, 1, "a", 0))) __PYX_ERR(0, 14, __pyx_L1_error)
  __pyx_r = __pyx_pf_14cython_control_9c_control_2position_control(((struct __pyx_obj_14cython_control_c_control *)__pyx_v_self), ((PyArrayObject *)__pyx_v_a));
...
static PyObject *__pyx_pf_14cython_control_9c_control_2position_control(struct __pyx_obj_14cython_control_c_control *__pyx_v_self, PyArrayObject *__pyx_v_a) {
  ...
  __pyx_pybuffernd_a.rcbuffer = &__pyx_pybuffer_a;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_a.rcbuffer->pybuffer, (PyObject*)__pyx_v_a, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 14, __pyx_L1_error)
  }
 ...
 *         self.c_control.GeometricPositionController(<double*> a.data)             # <<<<<<<<<<<<<<
 */
  __pyx_v_self->c_control->GeometricPositionController(((double *)__pyx_v_a->data));
...
static PyMethodDef __pyx_methods_14cython_control_c_control[] = {
  {"position_control", (PyCFunction)__pyx_pw_14cython_control_9c_control_3position_control, METH_O, 0},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_14cython_control_c_control) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  __pyx_type_14cython_control_c_control.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "c_control", (PyObject *)&__pyx_type_14cython_control_c_control) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
