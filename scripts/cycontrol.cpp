...
static int __pyx_pw_14cython_control_9c_control_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_m,&__pyx_n_s_J,&__pyx_n_s_gains,0};
...
static int __pyx_pf_14cython_control_9c_control___cinit__(struct __pyx_obj_14cython_control_c_control *__pyx_v_self, double __pyx_v_m, PyArrayObject *__pyx_v_J, PyArrayObject *__pyx_v_gains) {
